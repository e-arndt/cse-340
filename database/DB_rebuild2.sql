...
-- Create new Schema type called account_type with 3 options
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');


-- Create classification table if not present, add column attributes
CREATE TABLE IF NOT EXISTS public.classification (
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name VARCHAR NOT NULL,
    CONSTRAINT classification_pk PRIMARY KEY (classification_id),
    CONSTRAINT classification_name_uk UNIQUE (classification_name)
);


-- Create account table if not present, add column attributes
CREATE TABLE IF NOT EXISTS public.account (
    ...
    CONSTRAINT account_email_uk UNIQUE (account_email)
);


-- Create inventory table if not present, add column attributes
...
-- Add classification types if missing; Add FK to link inventory and classification tables
...
VALUES
    ...
    ('Toyota', 'Avalon XLS', 1995,
     ...
     '/images/avalon.jpg', '/images/avalon-tn.jpg', 5500, 82000, 'Pearl White', 5),
    ...
    ('Plymouth', 'Satellite', 1968,
     ...
     '/images/satellite.jpg', '/images/satellite-tn.jpg', 20000, 67500, 'Frost Blue', 5),
    ...
    ('Lincoln', 'Continental', 1979,
     ...
     '/images/continental.jpg', '/images/continental-tn.jpg', 35000, 78000, 'Champagne', 5
    );


-- Confirmation Query: Vehicles in the Sport Classification
...
/*
===========================================
 CSE Motors – Admin Approval System Additions
 Author: Instructor provided
 Altered: Eric Arndt
 Date: 10-18-2025 (Version 2 Final)
 Description:
   Adds approval-related columns, timestamps,
   foreign key relationships, and indexes
   to the classification and inventory tables.
   Removed outdated Hummer update statement.
===========================================
*/
...
ALTER TABLE public.classification
    ...
    ADD CONSTRAINT fk_classification_account
...
-- Index for account_id (used by Admin approvals)
CREATE INDEX IF NOT EXISTS fki_classification_account_id
    ON public.classification (account_id ASC NULLS LAST);
...
-- Index for account_id (used by Admin approvals)
CREATE INDEX IF NOT EXISTS fki_inventory_account_id
    ON public.inventory (account_id ASC NULLS LAST);
...
-------------------------------------------
 ...
 type ROLLBACK; in pgAdmin’s query tool
